...
(function ($) {
    ...
    function openCanvasMenu() {
        ...
        $(".canvas__open").addClass("active").attr("aria-expanded", "true");
    }

    function closeCanvasMenu() {
        $(".offcanvas-menu-wrapper").removeClass("active");
        $(".offcanvas-menu-overlay").removeClass("active");
        $(".canvas__open").removeClass("active").attr("aria-expanded", "false");
    }
    ...
    // Keyboard support since the button uses role="button"
    $(".canvas__open").on('keydown', function (e) {
    ...
    $(document).ready(function () {
        $('.faq__question').on('click', function () {
            ...
            if ($item.hasClass('active')) {
                ...
                $item.siblings('.faq__item').removeClass('active');
